                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <ul class="breadcome-menu"@if (app()->getLocale()=='ar') style="direction: rtl" @endif>
                                ...
                                <li>
                                    <span class="bread-blod">Suppliers</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="product-payment-inner-st">
                        <div class="comment_form_area">
                            ...
                            <form action="{{ route('AdminSupplier.update',$supplier->id) }}" method="POST"  enctype="multipart/form-data">
                                    ...
                                    <div class="file-upload-inner file-upload-inner-right ts-forms">
                                        <div class="input append-small-btn">
                                            <div class="file-button">
                                                Browse
                                                <input type="file" onchange="document.getElementById('append-small-btn').value = this.value;" id="logo" name="logo"  value="{{ $supplier->logo }}">
                                            </div>
                                            <input type="text" id="append-small-btn" placeholder="{{ $supplier->logo }}" id="logo" name="logo"  value="{{ $supplier->logo }}">
                                        </div>
                                    </div>
                                </div>

                                <div class="form-group  col-md-4">
                                    {{-- <img src="{{ asset('uploads/suppliers/'.$supplier->logo) }}" style="width: 135px;height:80px"> --}}
                                    <img src="{{asset('uploads/suppliers')}}/{{ $supplier->logo }}" style="width: 200px;height:100px">
                                </div>
                                ...
                                <div class="form-group col-md-12">
                                    <label><input type="checkbox"  id="active" name="active"  {{ ($supplier->active == 1 ? 'checked' : '')}}   value="1"  /> Is Active </label>
