                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                    <div class="product-payment-inner-st">
                        <div class="comment_form_area">
                            <h3>Edit Client</h3>
                            <br />
                            <form action="{{ route('AdminClient.update',$client->id) }}" method="POST"  enctype="multipart/form-data">
                                    ...
                                    <div class="file-upload-inner file-upload-inner-right ts-forms">
                                        <div class="input append-small-btn">
                                            <div class="file-button">
                                                Browse
                                                <input type="file" onchange="document.getElementById('append-small-btn').value = this.value;" id="logo" name="logo"  value="{{ $client->logo }}">
                                            </div>
                                            <input type="text" id="append-small-btn" placeholder="{{ $client->logo }}" id="logo" name="logo"  value="{{ $client->logo }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-12">
                                    <label>Website</label>
                                    <input type="text" class="form-control" id="website_url" name="website_url"   value="{{ $client->website_url }}" >
                                    <span class="text-danger d-block" id="website_url-error"></span>
                                </div>

                                <div class="form-group col-md-12">
                                    <label><input type="checkbox"  id="active" name="active"  {{ ($client->active == 1 ? 'checked' : '')}}   value="1"  /> Is Active </label>
