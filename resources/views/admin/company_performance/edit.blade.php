                        ...
                        <div class="comment_form_area">
                            ...
                            <form action="{{ route('AdminCompanyPerformance.update',$company_performance->id) }}" method="POST"  enctype="multipart/form-data">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="en_title" name="en_title"  value="{{$company_performance->en_title}}" />
                                </div>

                                <div class="form-group col-md-6">
                                    <label>Ar Title	</label>
                                    <input type="text" class="form-control" id="ar_title" name="ar_title"  value="{{$company_performance->ar_title}}">
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    <label>En Text	</label>
                                    <textarea id="message" name="en_subTitle"  value="" >{{$company_performance->en_subTitle}}</textarea>
                                </div>

                                <div class="form-group col-md-6">
                                    <label>Ar Text</label>
                                    <textarea id="message" name="ar_subTitle"  value=""  >{{$company_performance->ar_subTitle}}</textarea>
                                </div>
