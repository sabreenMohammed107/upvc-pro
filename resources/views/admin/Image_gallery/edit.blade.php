                            ...
                            <form action="{{ route('AdminImageGallery.update',$image_gallery->id) }}" method="POST"  enctype="multipart/form-data">
                                ...
                                {{ csrf_field() }}
                                 ...
                                 <div class="form-group col-md-12">
                                    <label><input type="checkbox"  id="active" name="active"  value="1"  {{ ($image_gallery->active == 1 ? 'checked' : '')}}   /> Is Active </label>
                                </div>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="file-upload-inner file-upload-inner-right ts-forms">
                                        <div class="input append-small-btn">
                                            ...
                                            <input type="text" id="append-small-btn"  name="image" placeholder="{{$image_gallery->image}}" >
                                        </div>
                                    </div>
                                </div>
