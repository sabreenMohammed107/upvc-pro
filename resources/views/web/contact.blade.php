					...
					<div class="ftco-footer-widget">
						...
						<div class="col-md d-flex topper align-items-center align-items-stretch py-2 mb-4 no-pl">
							...
							<div class="text mr-2">
								...
								<span> <script type="text/javascript"><!--/* Generated by www.email-encoder.com */
...
// --></script><noscript>Please enable JavaScript to see the email address (<a href="https://www.email-encoder.com/enablejs/" target="_blank" rel="noopener noreferrer">How-to</a>).</noscript></span>
							</div>
						</div>
					</div>
				</div>
