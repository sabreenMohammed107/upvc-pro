...
@section('content')
    <section class="home-slider owl-carousel">
        @foreach ($homeSliders as $slider)
            <div class="slider-item  {{ LaravelLocalization::getCurrentLocale() === 'ar' ? 'text-right' : '' }}"
                style="background-image:url({{ asset('uploads/home-sliders') }}/{{ $slider->image }});max-height:470px">
                <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div style="width:290px;">
                        ...
                        <img class="img-layer" src="{{ asset('uploads/companies') }}/{{ $company->about_image }}"
                            alt="no-image">
                    </div>
                </div>
                <div
                    ...
                    <p>
                        @if (LaravelLocalization::getCurrentLocale() === 'en')
                            <a href="{{ asset('uploads/companies') }}/{{ $company->company_catalogue_pdf }}" download
                                class="btn btn2 btn-primary">{{ __('links.dawnload_catalog') }}</a>
                        @else
                            <a href="{{ asset('uploads/companies') }}/{{ $company->ar_catalogue_pdf }}" download
                                class="btn btn2 btn-primary">{{ __('links.dawnload_catalog') }}</a>
                        @endif
                    </p>
                </div>
    ...
    <section class="ftco-section" style="background-color:#F9F9F9">
        <div class="container">
            <div class="row justify-content-center mb-4 pb-2">
                <div class="col-md-8 text-center heading-section ftco-animate">
                    <h2 style="color:rgba(223,223,223,.3);margin-bottom:-50px;font-size:70px">{{ __('links.products') }}
                    </h2>
                    ...
                    <div class="col-md-4 course ftco-animate">
                        <div class="product">
                            <div class="img product-img"
                                style="background-image: url('{{ asset('uploads/products') }}/{{ $product->master_image ?? '' }}');">
                            </div>
                            <div class="text pt-4">
                                <div class="row">
                                    <div class="col-md-8">
                                        <h3>
                                            ...
                                            @else
                                                {{ $product->category->ar_name ?? '' }} @endif
                                        </h3>
                                    </div>
                                    <div class="col-md-4">
                                        <p>{{ __('links.show_more') }}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="product-overlay hvr-sweep-to-bottom">
                                <div class="product-overlay-text">
                                    ...
                                    <p><a href="{{ LaravelLocalization::localizeUrl('/single-product/' . $product->id) }}"
                                            class="btn btn-primary2">{{ __('links.show_more') }}</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row dir-rtl">
                <div class="col-md-8 py-5 pr-md-4 ftco-animate">
                    <h2 style="color:rgba(223,223,223,.3);margin-bottom:-50px;font-size:70px">
    ...
    <section class="ftco-section" style="background-color:#FBF8F8">
        <div class="container">
            <div class="row justify-content-center mb-4 pb-2">
                <div class="col-md-8 text-center heading-section ftco-animate">
                    <h2 style="color:rgba(223,223,223,.3);margin-bottom:-50px;font-size:70px">{{ __('links.why_us') }}
                    </h2>
                            ...
                            @if ($index <= 2)
                                <div class="col-lg-12">
                                    <div class="services-2 d-flex">
                                        <div class="icon mt-2 d-flex justify-content-center align-items-center"><a href="#"
                                                class=""></a><span>{{ $index + 1 }}</span></div>
                                        <div class="text px-3">
                                            <a href="#">
                                                <h3 class="hvr-wobble-skew">
                                                    @if (LaravelLocalization::getCurrentLocale() === 'en')
                                                        {{ $whyRow->en_title }}
                                                    @else
                                                        {{ $whyRow->ar_title }}
            ...
            <div class="row dir-rtl">
                <div class="col-lg-6 ftco-animate">
                    <div class="product" style="height:368px;">
                        <div>
                            <img src="{{ asset('uploads/blogs') }}/{{ $blog->image ?? '' }}" alt="no-image"
                                class="img-fluid" style="height:368px;">
                        </div>
                        ...
                        <div class="product-overlay hvr-sweep-to-bottom">
                            <div class="product-overlay-text px-2">
                                ...
                                @if ($blog)
                                    <p><a href="{{ LaravelLocalization::localizeUrl('/single-blog/' . $blog->id) }}"
                                            class="btn btn-primary2"><span
                                                class="ion-ios-play"></span>{{ __('links.show_more') }}</a></p>
                                @endif
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="product" style="max-height:171px;">
                                    <a>
                                        <img src="{{ asset('uploads/blogs') }}/{{ $blog->thumbnail ?? '' }}"
                                            alt="no-image" class="img-article" />
                                    </a>
                                    <div class="product-overlay hvr-sweep-to-bottom">
                                        <div class="product-overlay-text">
                                            <p></p>
                                            <a href="{{ LaravelLocalization::localizeUrl('/single-blog/' . $blog->id) }}"
                                                class="btn btn-primary2">{{ __('links.show_more') }}</a>
                                        </div>
                                    </div>
                                </div>
    ...
    <section class="ftco-section" style="background-color:#FBF8F8;">
        <div class="container">
            <div class="row justify-content-center mb-4 pb-2">
                <div class="col-md-8 text-center heading-section ftco-animate">
                    <h2 style="color:rgba(223,223,223,.3);margin-bottom:-50px;font-size:70px">{{ __('links.materials') }}
                    </h2>
                    ...
                    <div class="slider">
                        <div class="logos">
                            @foreach ($materials as $material)
                                <img style="padding: 25px; height: 150px; width: 30%;display: inline-block;" alt="no-image"
                                    src="{{ asset('uploads/materials') }}/{{ $material->logo }}" />
                            @endforeach
                        </div>
                    </div>
                </div>
