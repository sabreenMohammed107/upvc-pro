    ...
    <div class="container">
        <div class="row justify-content-center align-items-center">
            <div class="col-lg-7 ftco-animate">
                <div class="mb-2">
                    <p>
                        <img src="{{ asset('uploads/product_imgs/' . $images[0]->image) }}" alt="test" class="img-fluid">
                    </p>
                    <div>
                    </div>
                </div>
                  ...
                  <table class="table ">
                      <tbody>
                          <tr class="table-light ">
                              ...
                              <td class="clr-mgreen">{{ $product->thickness }} {{ __('links.thick_mm') }}</td>
                          </tr>
                          <tr class="table-light ">
                              <td>{{ __('links.chambers') }}</td>
                              <td class="clr-mgreen">|</td>
                              <td class="clr-mgreen">{{ $product->chambers }} {{ __('links.chamber_no') }}</td>
                          </tr>
                          <tr class="table-light ">
                              <td>{{ __('links.glass') }}</td>
                              <td class="clr-mgreen">|</td>
                              <td class="clr-mgreen">{{ $product->glass }} {{ __('links.galss_mm') }}</td>
                          </tr>
